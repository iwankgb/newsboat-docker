...
RUN curl -L -O https://github.com/newsboat/newsboat/archive/r2.31.tar.gz
RUN tar xf r2.31.tar.gz
WORKDIR newsboat-r2.31
...
RUN curl -L -o /bin/gosu https://github.com/tianon/gosu/releases/download/1.16/gosu-amd64
