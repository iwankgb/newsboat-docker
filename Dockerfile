...
RUN curl -L -O https://github.com/newsboat/newsboat/archive/r2.26.tar.gz
RUN tar xf r2.26.tar.gz
WORKDIR newsboat-r2.26
...
RUN curl -L -o /bin/gosu https://github.com/tianon/gosu/releases/download/1.14/gosu-amd64
